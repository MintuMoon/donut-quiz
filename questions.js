...
const baseQuestions = [
  ...
  },
  {
    ...
    a: [
      ...
      {
        text: "Time manipulation (to enjoy the peaceful moments)",
        type: "matcha",
      },
  ...
  },
  {
    ...
    a: [
      ...
      {
        text: "I love all seasons, as long as there is adventure",
        type: "bacon",
      },
    ],
  },
  ...
  },
  {
    ...
    a: [
      ...
      {
        text: "Heavy metal, hip-hop, or experimental electronic",
        type: "bacon",
      },
    ],
  },
...
const nouns = [
  ...
  {
    name: "crystal",
    classic: "Clear Quartz",
    sprinkles: "Amethyst",
    jelly: "Rose Quartz",
    matcha: "Green Aventurine",
    bacon: "Pyrite",
  },
  {
    name: "historical era",
    classic: "The Victorian Era",
    sprinkles: "The Roaring Twenties",
    jelly: "The Renaissance",
    matcha: "Ancient Kyoto",
    bacon: "The Pirate Golden Age",
  },
  {
    name: "comfort food",
    classic: "Mashed Potatoes",
    sprinkles: "Loaded Pizza",
    jelly: "Warm Berry Pie",
    matcha: "Hot Miso Soup",
    bacon: "Spicy Chili Tacos",
  },
  {
    name: "dessert",
    classic: "Vanilla Custard",
    sprinkles: "Rainbow Cupcake",
    jelly: "Cherry Tart",
    matcha: "Matcha Mochi",
    bacon: "Maple Bacon Waffle",
  },
  {
    name: "mythology",
    classic: "Roman Order",
    sprinkles: "Norse Festivals",
    jelly: "Egyptian Mysteries",
    matcha: "Eastern Philosophy",
    bacon: "Celtic Rebellion",
  },
  {
    name: "art style",
    classic: "Classic Realism",
    sprinkles: "Vibrant Pop Art",
    jelly: "Impressionist Dreams",
    matcha: "Japanese Minimalism",
    bacon: "Edgy Street Graffiti",
  },
  {
    name: "scenery",
    classic: "Cozy Study Room",
    sprinkles: "Amusement Park",
    jelly: "Rainy Cozy Cafe",
    matcha: "Bamboo Forest Garden",
    bacon: "Neon Cyberpunk Alley",
  },
  {
    name: "accessory",
    classic: "Vintage Leather Watch",
    sprinkles: "Glittery Sunglasses",
    jelly: "Silver Heart Locket",
    matcha: "Handmade Wooden Ring",
    bacon: "Spiked Leather Collar",
  },
  {
    name: "superpower",
    classic: "Invulnerability",
    sprinkles: "Teleportation",
    jelly: "Empathy",
    matcha: "Telekinesis",
    bacon: "Pyrokinesis",
  },
  {
    ...
    sprinkles: "Art Deco",
    jelly: "Gothic",
    matcha: "Traditional Zen",
    bacon: "Brutalist",
  },
  {
    name: "beverage",
    classic: "Warm Milk",
    sprinkles: "Fizzy Soda",
    jelly: "Red Wine",
    matcha: "Green Tea Latte",
    bacon: "Double Espresso Shot",
  },
  {
    name: "musical instrument",
    classic: "Grand Piano",
    sprinkles: "Electric Guitar",
    jelly: "Harp",
    matcha: "Bamboo Flute",
    bacon: "Drums",
  },
  ...
  },
  {
    name: "tree",
    classic: "Oak",
    sprinkles: "Cherry Blossom",
    jelly: "Weeping Willow",
    matcha: "Bonsai Pine",
    bacon: "Redwood",
  },
  {
  ...
  },
  {
    ...
    sprinkles: "Tropical Beach",
    jelly: "Mystic Forest",
    matcha: "Zen Garden",
    bacon: "Active Volcano",
  },
  {
    name: "philosophy",
    classic: "Stoicism",
    sprinkles: "Existentialism",
    jelly: "Romanticism",
    matcha: "Taoism",
    bacon: "Nihilism",
  },
...
// Crop to exactly 191 normal questions (191 normal + 1 secret = 192 total)
...
const results = {
  classic: {
    ...
    emoji: "🍩",
    description:
      "You are the Classic Glazed Donut! Elegant, reliable, and deeply loved by everyone. You don't need fancy decorations or loud gimmicks to prove your worth—your simple, warm, and sweet soul is more than enough.",
  },
  sprinkles: {
    title: "Chocolate Sprinkles Donut",
    emoji: "🧁",
    description:
      "You are the Chocolate Sprinkles Donut! Full of endless energy, color, and joy. You are the absolute life of the party, always ready to make others laugh and lift up their spirits.",
  },
  jelly: {
    title: "Strawberry Jelly-Filled Donut",
    emoji: "🍓",
    description:
      "You are the Strawberry Jelly-Filled Donut! You might look simple on the outside, but you have a beautiful, deep, and sweet surprise hidden inside. You feel the world very deeply.",
  },
  matcha: {
    title: "Matcha Green Tea Donut",
    emoji: "🍵",
    description:
      "You are the Matcha Green Tea Donut! Peaceful, wise, and absolutely unique. You prefer quiet nature over loud parties, and you always strive for zen, harmony, and self-growth.",
  },
  bacon: {
    title: "Maple Bacon Donut",
    emoji: "🥓",
    description:
      "You are the Maple Bacon Donut! Bold, adventurous, and completely unconventional. You are not afraid to combine things that seem impossible, and you absolutely love breaking the rules.",
  },
};
